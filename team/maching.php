            ...
            if ($result = mysqli_query($conn, $sql)) {
                ...
                if ($resultCheck > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        //"<img src='/team/img/'". $k4[0]. "width='180' height='180'
                        //style='border-radius: 50%;'>".
                        echo "<div class='button005'>" .
                            '<button type="submit" name="mach" value=' . $row['realname'] . ">" . $row['realname'] .
                            "</div>" . "<br>";
                    }
                } else {
