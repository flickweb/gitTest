...
if (isset($_POST['hcaman'])) {
    $_SESSION["hcaman"] = $_POST["hcaman"];
    $_SESSION['hcag'] = $_SESSION['hcaman'];
} elseif (isset($_POST['hcawoman'])) {
    $_SESSION["hcawoman"] = $_POST["hcawoman"];
    $_SESSION['hcag'] = $_SESSION['hcawoman'];
} elseif (isset($_POST['hcaother'])) {
    $_SESSION["hcaother"] = $_POST["hcaother"];
    $_SESSION['hcag'] = $_SESSION['hcaother'];
}
?>
<!DOCTYPE html>
<html lang="ja">
